      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        {/* <form className="d-flex" role="search">
          ...
          <div className="form-check form-switch text-danger">
            <input className="form-check-input mx-1" type="checkbox" onClick={props.toggleModeTwo} role="switch" id="flexSwitchCheckDefault"/>
...
// In bootstrap: primary-blue, success-green, danger-red